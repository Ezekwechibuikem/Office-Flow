...
class CustomUserAdmin(UserAdmin):
    ...
    # ========== READONLY FIELDS ==========
    # These fields can be viewed but not edited in the form
    readonly_fields = [
...
# REGISTER MODELS
# ============================================================================
# Register CustomUser with CustomUserAdmin configuration
admin.site.register(CustomUser, CustomUserAdmin)

# Note: Department, Unit, and EmployeeSuspension are already registered
# using @admin.register decorator above